...
import model.imageexporter.PPMExporter;
...
/**
 * Class to test the PPM exporter.
 */
public class TestPPMExporter {
  ...
  public void testFileString() {
    ImageExporter exporter = new PPMExporter(new_image_3x2);
    assertEquals("P3\n"
        + "3 2\n"
        + "255\n"
        + "100\n"
