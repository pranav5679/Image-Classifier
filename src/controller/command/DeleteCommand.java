...
/**
 * The representation of a delete command.
 */
public class DeleteCommand extends Command {

  /**
   * Constructs a command that uses the removeLayer method.
   * @param tokens the script used to identify when
   *               the user wants to delete a layer
   */
  ...
  public boolean execute(MultiLayerImageImpl multiLayerImage) {
    ...
    try {
      ...
      success = multiLayerImage.removeLayer(id);
    }
    catch (NumberFormatException e) {
      e.printStackTrace();
    }
